define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'withdrawalsuser/index/'+adminids,
                    add_url: 'withdrawalsuser/add',
                   // edit_url: 'withdrawalsuser/edit',
                    //del_url: 'withdrawalsuser/del',
                    multi_url: 'withdrawalsuser/multi',
                    table: 'withdrawalsuser',
                }
            });
