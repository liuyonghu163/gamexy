            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'ingot', title: __('金币数'),operate: false},
                        {field: 'count_num', title: __('推广人数'),operate: false},
                        {field: 'status', title: __('Status'),align: 'center', searchList: $.getJSON('user/searchlist/'),formatter: Controller.api.formatter.status_text},
        ...
        api: {
            ...
            formatter: {
                ...
                status_text: function (value, row, index) {
                    ...
                    return "<a href='javascript:;' class='btn btn-" + btn + " btn-xs btn-change'>" + type_name + "</a>";
                }, 
